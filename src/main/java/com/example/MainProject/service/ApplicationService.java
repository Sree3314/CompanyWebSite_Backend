...
public class ApplicationService {
	...
	/**
	 * NEW METHOD: Retrieves all job applications. This method will be called by the
	 * ApplicationController when a manager requests all applications.
	 * 
	 * @return A list of all applications.
	 */
	public List<Application> findAllApplications() {
		return applicationRepository.findAll(); // JpaRepository provides findAll() by default
	}
}