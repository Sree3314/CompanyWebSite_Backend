...
public class UploadController {
    ...
    public ResponseEntity<UploadDTO> createUpload(@Valid @RequestBody UploadRequest uploadRequest) {
        ...
        try {
            ...
            throw e; // Re-throw handled exceptions (e.g., NOT_FOUND for user)

        } catch (Exception e) {

            // Log unexpected errors

            // logger.error("An unexpected error occurred while creating upload: {}", e.getMessage(), e);
    ...
    public ResponseEntity<List<UploadDTO>> getMyUploads() {
        ...
        try {
            ...
            // Use externalEmployeeId for fetching personal uploads as requested
